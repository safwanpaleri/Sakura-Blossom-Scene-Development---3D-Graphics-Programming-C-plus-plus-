...
// Sets the shader parameters including transformation matrices, depthmap, heightmap, and texture.
void ShadowShader::setShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX &worldMatrix, const XMMATRIX &viewMatrix, const XMMATRIX &projectionMatrix, ID3D11ShaderResourceView* texture, ID3D11ShaderResourceView*depthMap, SingleLight* light, ID3D11ShaderResourceView* heightmaptexture)
{
